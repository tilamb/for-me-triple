    ...
    return <div>
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="flex-ns mhn2-ns mb3">
              {(entry.getIn(["data", "formations"]) || []).map((product, i) => <div className="ph2-ns w-50-ns" key={i}>
            ...
            <div className="tc">
              <a href="#" className="btn raise">Voir tous les produits</a>
            </div>
          </div>
        </div>
        ...
        <div className="bg-grey-1 pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="tc">
              <a href="{{.buttonLink}}" className="btn raise">Lire la suite</a>
            </div>
